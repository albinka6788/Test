...
CREATE PROCEDURE [dbo].[MaintainApplicationCustomSession]
(
	 @QuoteId			BIGINT
...
BEGIN
	...
	BEGIN		
		INSERT INTO PurchaePathCustomSession(Id,QuoteId,SessionData,CreatedBy,IsActive) VALUES((NEXT VALUE FOR SEQUENCEPurchaePathCustomSession),@QuoteId,@SessionData,@CreatedBy,@IsActive);
	END
	ELSE
	BEGIN
		UPDATE PurchaePathCustomSession SET SessionData=@SessionData,ModifiedDate=GETDATE() WHERE QuoteId=@QuoteId;
	END

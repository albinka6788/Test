...
@ExampleCall : EXEC GetReferralThresholdClaims 'AK','0005','200500'

*/
-- ================================================

CREATE PROCEDURE GetReferralThresholdClaims
(
	 @StateCode			CHAR(2)
...
BEGIN
	...
	SELECT @OrgActivityType = ISNULL(OrganizationActivityType,0) FROM FrequencyClass WHERE StateCode=@StateCode AND ClassCode=@ClassCode AND IsActive=1;
